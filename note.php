...
width: 15vw;
	...
	<body>
		<form action="hjk.php" method="post">
		<div class="top">
			与狼共舞送货单
		</div>
    ...
    height: 25px;
    text-align: center;
    color: white;" target="_blank">全部送货单</a><a href="http://192.168.0.86:99/ylgw/p_add.php" style="display: inline-block;
    text-decoration: none;
    margin-left: 61px;
    background: #00c4ff;
    border-radius: 5px;
    ...
    height: 25px;
    text-align: center;
    color: white;" target="_blank">增加客户</a>
		<div class="choosebox" style="overflow: hidden;">
			...
			<div style="float: left;width: 40%;text-align: center;">		
					<span style="margin-right: 5px;">送货日期:</span><input readonly type="text" name="s_time" id="tdate" value="" style="color: #000;font-size: 16px;width:8vw"  />
			</div>
		...
		<div class="tab" style="overflow: visible;">
			<div class="box">
				<div class="textbox ">
					...
					<span class="inp"><input class="loadbtn" type="text" name="sname" id="inputString" onkeyup="lookup(this.value);" onblur="fill();" /></span>
...
<div class="thcls fivw">
		...
		<div id="main" class="order2" style="position: absolute;left: 150px;top: 100px;width: 49vw">
...
addnew+='<div class="tdcls tenvw"><input type="hidden" class="danwei" name="jk21[]" id="" readonly value="" /><input class="coster" type="text" name="jk211[]" id="" readonly value="'+$(this).parent().parent().find(".tdcls").eq(3).text()+'" /></div>';//单位
				 ...
				 if(zj==undefined){		 	 
				 	zongji+='<div class="tdcls fivw"><input class="allcount" style="color:red;" type="text" name="jk9" id="" value="0" /></div><div class="tdcls fivw"></div></div>'
				 }
				 else{

				 	aval=Number(zj).toFixed(2);
				 	zongji+='<div class="tdcls fivw"><input class="allcount" style="color:red;" readonly type="text" name="jk9" id="" value="'+aval+'" /></div><div class="tdcls fivw"></div></div>'
				 $(".zongji").remove();
				 }			 
			...
			$(document).on("click",'.delete',function(){
				...
				if($(".order1").find('.tdclsbox').length==2){
					...
					dzongj+='<div class="tdcls tenvw"></div><div class="tdcls tenvw"></div><div class="tdcls tenvw"></div><div class="tdcls tenvw" ></div><div class="tdcls fivw" ></div><div class="tdcls fivw" ></div><div class="tdcls fivw" >总计</div>'
				 	...
				 	dzongj+='<div class="tdcls fivw"><input class="allcount" style="color:red;" readonly type="text" name="jk8" id="" value="'+eval+'" /></div><div class="tdcls fivw"></div></div>'
					$(this).parent().parent().remove();
					$(".zongji").remove();
